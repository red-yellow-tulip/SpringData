...
@ComponentScan(basePackages={"DB.type4_JpaRepository"})
@EnableJpaRepositories(basePackages ={"DB.type4_JpaRepository"})
@EnableTransactionManagement
public class ConfDataSource {

    private final static String basePac = "DB.type4_JpaRepository";
